...
import org.tycloud.component.amqp.AmqpMessage;
import org.tycloud.component.amqp.AmqpSender;
import org.tycloud.component.notification.face.model.SmsVerifyModel;
import org.tycloud.component.notification.face.orm.dao.SmsVerifyMapper;
import org.tycloud.component.notification.face.orm.entity.SmsVerify;
import org.tycloud.component.notification.sms.SmsTemplate;
import org.tycloud.component.notification.face.model.*;
 ...
 */
@Component
public class SmsVerifyService extends BaseService<SmsVerifyModel, SmsVerify, SmsVerifyMapper> implements IService<SmsVerify> {
    private final Logger logger = Logger.getLogger(SmsVerifyService.class);
