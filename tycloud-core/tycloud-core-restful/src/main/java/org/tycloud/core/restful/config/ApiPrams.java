...
public class ApiPrams {
     ...
     * @return
     */
    public ApiPrams putPathparams(String...pathparams)
    {
     ...
     * @return
     */
    public ApiPrams putRequestParams(String...requestParams)
    {
     ...
     * @return
     */
    public ApiPrams putRequestBody(String paramName,Object value)
    {
