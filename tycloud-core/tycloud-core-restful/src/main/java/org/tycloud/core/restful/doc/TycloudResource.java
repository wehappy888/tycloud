package org.tycloud.core.restful.doc;
...
public @interface TycloudResource {
	/**
	 * indicates the module which the controller with this annotation belongs to
	 * TODO.
	 * @return
	 */
	String module();
     ...
     * on the controller, but can be any other value as well. It will serve as the path
     ...
     * <p/>
     * This should be a short description of the controller.
     */
    ...
    /**
     * Optional explicit ordering of this API controller in the Resource Listing.
     */
