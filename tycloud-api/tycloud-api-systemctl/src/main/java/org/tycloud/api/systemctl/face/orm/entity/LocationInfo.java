...
import org.tycloud.api.systemctl.face.service.LocationInfoService;
 ...
 * </pre>
 */
@EntityCache(keyPrefix = LocationInfoService.LOCATIONINFO,storageMode = StorageMode.VALUE)
@TableName("systemctl_location_info")
public class LocationInfo extends BaseEntity<LocationInfo>
{
	...
	@CacheKey(keyPrefix = LocationInfoService.LOCATIONINFO,order = 1)
